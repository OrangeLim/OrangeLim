...
import { loadAudio } from './libs/audio.js';
...
class App{
	...
	loadCollege() {
            ...
            loader.load(
                ...
                function (gltf) {
                    ...
                    if (pokemonFile === 'Pokemon 8.glb') {
                        ...
                        pokemon.rotation.set(0, 0, 135); // Example rotation; adjust as needed
                    }
        ...
        loadPokemon('Pokemon 7.glb');
        loadPokemon('Pokemon 8.glb');
        loadPokemon('Pokemon 9.glb');
