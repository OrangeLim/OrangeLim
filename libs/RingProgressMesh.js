...
class RingProgressMesh extends Mesh {
    ...
    updateText(text) {
      if (this.material && this.material.uniforms.uTextTexture) {
          ...
          const canvasHeight = 1024; // Height adjusted to fit the text and arc
          ...
          const textY = canvasHeight * 0.75; // Position text below the arc (three-quarters down the canvas height)
